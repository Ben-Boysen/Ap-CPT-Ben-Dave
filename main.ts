    ...
    if (heldItem == Sword) {
        for (let value of ListOfEnemies) {
            if (player1.overlapsWith(value) || Sword.overlapsWith(value)) {
                if (value == superGhost) {
                    statusbars.getStatusBarAttachedTo(StatusBarKind.EnemyHealth, value).value += -25
                } else {
...
function Make_Enemy (num: number, isSuper: boolean) {
    for (let index = 0; index < num; index++) {
        if (isSuper) {
            superGhost = sprites.create(img`
                ........................
                ........................
                .............5..........
                .........5...4..5.......
                ...
                ........................
                `, SpriteKind.Enemy)
            tiles.placeOnRandomTile(superGhost, sprites.dungeon.darkGroundCenter)
            GhostHealth = statusbars.create(20, 4, StatusBarKind.EnemyHealth)
            GhostHealth.value = 100
            GhostHealth.attachToSprite(superGhost, -20, 0)
            GhostHealth.setColor(8, 5)
        } else {
